import { Alert, ClientConfiguration, EmailTarget, Filter, SmsTarget, Source, TargetGroup, TelegramTarget, User, UserTopic } from './models';
...
export declare type MessageLogger = Readonly<{
...
export declare type NotifiClient = Readonly<{
    ...
    broadcastMessage: (input: ClientBroadcastMessageInput, signer: MessageSigner) => Promise<string | null>;
    ...
    createBonfidaAuctionSource: (input: ClientCreateBonfidaAuctionSourceInput) => Promise<Source>;

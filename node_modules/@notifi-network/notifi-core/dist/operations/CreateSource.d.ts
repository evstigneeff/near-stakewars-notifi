 ...
 */
export declare type CreateSourceInput = Readonly<{
    name: string;
    blockchainAddress: string;
    type: 'SOLANA_WALLET' | 'TERRA_WALLET' | 'ETHEREUM_WALLET' | 'TRIBECA_PROPOSALS' | 'REALM_PROPOSALS' | 'DIRECT_PUSH' | 'SOLANA_METAPLEX_AUCTION' | 'SOLANA_BONFIDA_AUCTION' | 'DIRECT_PUBLISH' | 'HEDGE_PROTOCOL' | 'BROADCAST' | 'SHARKY_PROTOCOL' | 'PORT_FINANCE' | 'METAPLEX_AUCTION_HOUSE' | 'ORCA';
}>;
export declare type CreateSourceResult = Source;
export declare type CreateSourceService = Readonly<{
